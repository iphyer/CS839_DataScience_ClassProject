...
Unfortunately, we have not achieved the required precision. The reasons are that we can not think of better features of person names. Unlike names of companies or organizations which usually contains clearly indications like "Ltd","NGOs","chartered" etc. 
